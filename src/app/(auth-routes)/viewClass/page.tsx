        ...
        <table className="w-full border border-gray-300">
          ...
          <tbody className="w-full text-sm text-gray-700">
            <tr className="border border-gray-300">
              ...
              <td className="px-4 py-6">Almeida</td>
            ...
            <tr className="border border-gray-300">
              <td className="px-4 py-6">1</td>
              <td className="px-4 py-6">Gabriel</td>
              <td className="px-4 py-6">A</td>
              <td className="flex gap-x-2 px-4 py-6">
                <button className="rounded-lg bg-blue-500 px-5 py-2.5 text-xl text-white">
                  <PiEyeBold />
            ...
            <tr className="border border-gray-300">
              <td className="px-4 py-6">1</td>
              <td className="px-4 py-6">Mirosmar</td>
            ...
            <tr className="border border-gray-300">
              <td className="px-4 py-6">1</td>
              <td className="px-4 py-6">Mariana</td>
            ...
            <tr className="border border-gray-300">
              <td className="px-4 py-6">1</td>
              <td className="px-4 py-6">Raquel</td>
              <td className="px-4 py-6">NR</td>
              <td className="flex gap-x-2 px-4 py-6">
                <button className="rounded-lg bg-blue-500 px-5 py-2.5 text-xl text-white">
                  <PiEyeBold />
            ...
            <tr className="border border-gray-300">
              <td className="px-4 py-6">1</td>
              <td className="px-4 py-6">Thamyres</td>
